...
// acender um indicador (LED) ao mesmo tempo. Utilizar duas teclas
// externas uma para aumentar a velocidade das piscadas do LED e outra
// para diminuir a velocidade das piscadas do LED. Pede-se o controle
// de velocidade de 1 a 60 piscadas por minuto.
*/
